...
return new class extends Migration
{
    ...
    {
        Schema::create('agg_daily_surface_metrics', function (Blueprint $table): void {
            $table->id();
            ...
            $table->unique(['metric_date', 'service', 'surface', 'platform'], 'agg_daily_surface_metrics_scope');
        });
    }
