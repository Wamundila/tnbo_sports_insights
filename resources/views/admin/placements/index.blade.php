        ...
        <div class="col-xl-4">
            <div class="panel-card">
                ...
                <form method="POST" action="{{ $editing ? route('admin.placements.update', $editing) : route('admin.placements.store') }}" class="d-grid gap-3">
                    ...
                    <div><label class="form-label">Block Type</label><input class="form-control" name="block_type" value="{{ old('block_type', $editing?->block_type) }}" placeholder="sponsor_card" required></div>
                    <div><label class="form-label">Allowed Creative Types</label><textarea class="form-control" name="allowed_creative_types" rows="3" placeholder="image_banner&#10;sponsor_card">{{ old('allowed_creative_types', $editing ? implode(PHP_EOL, $editing->allowed_creative_types ?? []) : '') }}</textarea></div>
            ...
            <div class="panel-card">
                ...
                <div class="table-responsive">
                    <table class="table align-middle mb-0">
                        ...
                        @empty
                            <tr><td colspan="5" class="text-center text-secondary py-4">No placements created yet.</td></tr>
                        @endforelse
                        </tbody>
                    </table>
                </div>
